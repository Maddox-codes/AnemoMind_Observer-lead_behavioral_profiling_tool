...
import numpy as np
import joblib
from worklife_rules import get_work_life_compatibility # Assuming this file is in the same directory

# --- MODEL LOADING ---
try:
    anxiety_model = joblib.load(r'C:\Users\kumar\OneDrive\Desktop\ANEMOMIND\anxiety_model.pkl')
    speech_speed_classes = joblib.load(r'C:\Users\kumar\OneDrive\Desktop\ANEMOMIND\speech_speed_classes.pkl')
    stability_model = joblib.load(r'C:\Users\kumar\OneDrive\Desktop\ANEMOMIND\stability_model.pkl')
    integrity_model = joblib.load(r'C:\Users\kumar\OneDrive\Desktop\ANEMOMIND\integrity_model.pkl')
    MODELS_LOADED = True
